...
import { ViewTypes, CellUnits, DATETIME_FORMAT, DATETIME_FORMAT } from '../config/scheduler-config';
        ...
        return {
          ...
          start: rule.origOptions.tzid ? this.localeMoment.utc(time).utcOffset(this.localeMoment().utcOffset(), true).format(DATETIME_FORMAT) : this.localeMoment(time).format(DATETIME_FORMAT),
            ...
            ? this.localeMoment
                ...
                .add(this.localeMoment(oldUntil).utcOffset() - this.localeMoment(item.start).utcOffset(), 'm')
